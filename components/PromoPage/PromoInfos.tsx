...
const PromoInfos = (props: Props) => {
  ...
  return (
    <div class="bg-black py-[27px] pb-[29px] lg:pb-0">
      <div class="max-w-[1270px] mx-auto">
        ...
        <div class="lg:flex lg:justify-between">
          ...
          <div class="lg:max-w-[544px] flex flex-col">
            <div class="flex items-start gap-[11px] mb-[31px] px-[10px] lg:px-0 lg:justify-between">
              ...
              <div class="">
                ...
                <p class="text-white text-sm font-bold leading-[18px] mb-2">
                  {productName}
                </p>
                <div class="border border-[#F2970E] rounded-lg w-full max-w-[218px] h-[45px] flex items-center justify-center lg:max-w-none">
                  <p class="text-[#F2970E] text-sm font-bold tracking-[0.7px] text-center">
                    E GANHE 1 NÚMERO DA SORTE*
                  </p>
                </div>
                <p class="text-white text-[17px] leading-[18px] mb-2">
                  Para concorrer a um
                </p>
                <p class="text-[#F2970E] text-[18px] leading-5 font-semibold mb-2">
                  {prizeName}
                </p>
                <a
                  href={productLink}
            ...
            <p class="text-white text-center text-[10px] leading-normal px-[28px] lg:px-0 lg:text-start lg:mt-auto">
              *Na compra do eBook você ganha 1 número da sorte para concorrer a
              promoção:{" "}
              {promoName}. O número será enviado diretamente no e-mail.
            </p>
          </div>
        </div>
      </div>
